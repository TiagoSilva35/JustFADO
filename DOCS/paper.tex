...
baseline up to $+3.8$, while reducing demographic-parity violation up to $21\%$ and equalized-odds violation by $26$--$42\%$ relative to the
...
and the corresponding performance results of \textsc{FADO} compared to the \textsc{ARF} and \textsc{RFR} baselines, demonstrating substantial improvements in fairness stability with competitive predictive performance.
\end{itemize}
