...
\pageset{Weakly reviews - KANs}{02}
\begin{frame}
    \ctitle{KANs}
    \tb{3.9}{4.72}{2.55}{\includegraphics[width=3.9in]{assets/D3KAN.png}}
    \tb{3.9}{0.45}{2.55}{\includegraphics[width=3.9in]{assets/ClassicKAN.png}}
    \tb{3.9}{8.99}{2.55}{\includegraphics[width=3.9in]{assets/fairKAN.png}}
